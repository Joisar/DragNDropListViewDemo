package com.mehuljoisar.dragndroplistviewdemo;
    ...
    private DragSortListView.DropListener onDrop =
            new DragSortListView.DropListener() {
                ...
                public void drop(int from, int to) {
                	...
                	Log.e(TAG, "lastIndex: "+lastIndex);
                	Log.e(TAG, "from: "+from+" to:"+to);
                	
                	
                    if (from != to) {
                    	//make first and last item stable forever
                 	if(from!=0 && to!=0 && from!=lastIndex && to!=lastIndex)
                  	{
                    	...
                    	{
                    		Toast.makeText(getActivity(), "Sorry ! You can't move this.", Toast.LENGTH_SHORT).show();
                    	}
                    }
                }
            };
